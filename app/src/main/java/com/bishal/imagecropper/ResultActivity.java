...
public class ResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri != null) {
            try {
                ImageCropView imageCropView = findViewById(R.id.imageCrop);
                imageCropView.getCropImageView().setImageUri(uri, null);
                imageCropView.getOverlayView().setShowCropFrame(false);
                imageCropView.getOverlayView().setShowCropGrid(false);
                imageCropView.getOverlayView().setDimmedColor(Color.TRANSPARENT);
            } catch (Exception e) {
