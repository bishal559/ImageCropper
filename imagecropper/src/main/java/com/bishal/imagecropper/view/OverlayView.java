...
import com.bishal.imagecropper.util.RectUtils;
...
public class OverlayView extends View {
    ...
    {
        mTouchPointThreshold = getResources().getDimensionPixelSize(R.dimen.image_crop_default_crop_rect_corner_touch_threshold);
        mCropRectMinSize = getResources().getDimensionPixelSize(R.dimen.image_crop_default_crop_rect_min_size);
        mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(R.dimen.image_crop_default_crop_rect_corner_touch_area_line_length);
    }
...
//        }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        mCircleDimmedLayer = a.getBoolean(R.styleable.image_crop_ImageCropView_image_crop_circle_dimmed_layer, DEFAULT_CIRCLE_DIMMED_LAYER);
        mDimmedColor = a.getColor(R.styleable.image_crop_ImageCropView_image_crop_dimmed_color,
                getResources().getColor(R.color.image_crop_color_default_dimmed));
        ...
        mShowCropFrame = a.getBoolean(R.styleable.image_crop_ImageCropView_image_crop_show_frame, DEFAULT_SHOW_CROP_FRAME);

        initCropGridStyle(a);
        mShowCropGrid = a.getBoolean(R.styleable.image_crop_ImageCropView_image_crop_show_grid, DEFAULT_SHOW_CROP_GRID);
    }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(R.styleable.image_crop_ImageCropView_image_crop_frame_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.image_crop_default_crop_frame_stoke_width));
        int cropFrameColor = a.getColor(R.styleable.image_crop_ImageCropView_image_crop_frame_color,
                getResources().getColor(R.color.image_crop_color_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = a.getDimensionPixelSize(R.styleable.image_crop_ImageCropView_image_crop_grid_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.image_crop_default_crop_grid_stoke_width));
        int cropGridColor = a.getColor(R.styleable.image_crop_ImageCropView_image_crop_grid_color,
                getResources().getColor(R.color.image_crop_color_default_crop_grid));
        mCropGridPaint.setStrokeWidth(cropGridStrokeSize);
        mCropGridPaint.setColor(cropGridColor);

        mCropGridRowCount = a.getInt(R.styleable.image_crop_ImageCropView_image_crop_grid_row_count, DEFAULT_CROP_GRID_ROW_COUNT);
        mCropGridColumnCount = a.getInt(R.styleable.image_crop_ImageCropView_image_crop_grid_column_count, DEFAULT_CROP_GRID_COLUMN_COUNT);
    }
