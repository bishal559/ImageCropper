...
import com.bishal.imagecropper.model.CropParameters;
import com.bishal.imagecropper.model.ImageState;
import com.bishal.imagecropper.task.BitmapCropTask;
import com.bishal.imagecropper.util.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.image_crop_ImageCropView_image_crop_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.image_crop_ImageCropView_image_crop_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
