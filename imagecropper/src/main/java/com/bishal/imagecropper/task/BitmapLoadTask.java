package com.bishal.imagecropper.task;
...
import com.bishal.imagecropper.ImageCropHttpClientStore;
import com.bishal.imagecropper.callback.BitmapLoadCallback;
import com.bishal.imagecropper.model.ExifInfo;
import com.bishal.imagecropper.util.BitmapLoadUtils;
...
public class BitmapLoadTask extends AsyncTask<Void, Void, BitmapLoadTask.BitmapWorkerResult> {
    ...
    private void downloadFile(@NonNull Uri inputUri, @Nullable Uri outputUri) throws NullPointerException, IOException {
        ...
        OkHttpClient client = ImageCropHttpClientStore.INSTANCE.getClient();
